...
namespace GeekQuiz.Entities
{
    ...
    {
        public TriviaDbContext db = new TriviaDbContext();
        public static readonly SampleData _instance = new SampleData();

    
        public SampleData()
        {
            db.TriviaQuestions = new List<TriviaQuestion>();
            db.TriviaAnswers = new List<TriviaAnswer>();
            db.TriviaOptions = new List<TriviaOption>();
            ...
            questions.Add(new TriviaQuestion
            {
                ...
                {
                    new TriviaOption { Title= "2000", IsCorrect= false , Id=1, QuestionId=1},
                    new TriviaOption { Title= "2001", IsCorrect= false  , Id=2, QuestionId=1},
                    new TriviaOption { Title= "2002", IsCorrect= true  , Id=3, QuestionId=1},
                    new TriviaOption { Title= "2003", IsCorrect= false  , Id=4, QuestionId=1}
                }).ToList()
            });
            ...
            questions.Add(new TriviaQuestion
            {
                ...
                Options = (new TriviaOption[]
                {
                    new TriviaOption { Title= "Contoso Ltd.", IsCorrect= false  , Id=5, QuestionId=2},
                    new TriviaOption { Title= "Initech", IsCorrect= false  , Id=6, QuestionId=2},
                    new TriviaOption { Title= "Fabrikam, Inc.", IsCorrect= false  , Id=7, QuestionId=2},
                    new TriviaOption { Title= "Northwind Traders", IsCorrect= true  , Id=8, QuestionId=2}
                }).ToList()
            });
